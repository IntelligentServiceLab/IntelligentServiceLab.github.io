...
- **Guosheng Kang**, **Zhuo Chen**, Jianxun Liu, Yang Wang, Pei Li*, Min Shi. Interactive Web API Recommendation via LLM-Enhanced Semantics and Multi-Round Reward Feedback. **Concurrency and Computation: Practice and Experience**,  Vol. 38, No. 8, pp. 1-15, 2026.
- **Guosheng Kang**, **Qiqi Chen**, Jiawei Chen, Jianxun Liu*, Buqing Cao. CoWAR: A General Complementary Web API Recommendation Framework based on Learning Model. **IEEE Transactions on Reliability**, Vol. 75, No. 1, pp. 1160-1174, 2026.
...
- **Guosheng Kang***, **Guotai He**, Yaling Tang, Junhua Xu, Xinyu You, Xiaocong Xiao. Ring Matrix Encoding-Based Global Optimization for Fault Recovery of Distribution Network with Distributed Generation. **Expert Systems With Applications**, Vol. 307, No. 2026, pp. 130998-131007, 2026.
...
- **Jiayu Li**, **Qingping Li**, Yan Li, Xin Ai, Jie Chen, Jiayan Xiang, **Guosheng Kang***. CS-LightGCL: Composition-Supervised LightGCL for Interactive Web API Recommendation. **International Joint Conference on Neural Networks**. IEEE Computer Society, pp. 1-8, 2025.
- **Jiayi Zhong**, **Yaling Tang**, Jiawei Chen, Xiaokang Zhou, Xiaocong Xiao\*, **Guosheng Kang**\*. Collaboration-Aware Service Composition Optimization for Production Factors Under Industrial Internet. **International Conference on Computer Supported Cooperative Work in Design**. IEEE Computer Society, pp. 1894-1899, 2025.
...
- **Huiyu Zhai**, Guang Jin, Xingxing Yang, **Guosheng Kang**. ColorMamba: Towards High-quality NIR-to-RGB Spectral Translation with Mamba. **The 16th Asian Conference on Machine Learning**. Springer, pp. 765-780, 2024.
